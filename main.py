...
if __name__ == "__main__":
    # 设置输入文件夹路径，请修改为实际路径
    INPUT_FOLDER = r"F:\科研\06Machine Learning, EEG, and Word Reading in Children\Decomposed strokes of Chinese characters\Slide_1"

    # 设置输出图片路径
    OUTPUT_PATH = r"F:\科研\06Machine Learning, EEG, and Word Reading in Children\output\Slide_1.png"
